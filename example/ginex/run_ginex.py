...
argparser.add_argument('--dataset', type=str, default='papers100M')
...
argparser.add_argument('--neigh-cache-size', type=int, default=500000000)
argparser.add_argument('--ginex-num-threads', type=int, default=8)
...
dataset_path = os.path.join('./Ginex', args.dataset + '-ginex')
